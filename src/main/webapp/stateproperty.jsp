                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?jsp echo $row['18'];?>" alt="pimage">
                                        
                                        <div class="sale bg-secondary text-white">For <?jsp echo $row['5'];?></div>
                                        <div class="price text-primary text-capitalize">$<?jsp echo $row['13'];?> <span class="text-white"><?jsp echo $row['12'];?> Sqft</span></div>
