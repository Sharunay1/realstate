...
<link rel="stylesheet" type="text/css" href="cssflaticon.css">
                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="propertydetail.jsp">Home</a></li>
            ...
            <div class="container">
					...
					<table class="items-list col-lg-12" style="border-collapse:inherit;">
                        ...
                        <tbody>
                            <tr>
                                <td>
									<img src="admin/property/44.jpg" alt="pimage">
                                    <div class="property-info d-table">
                                        <h5 class="text-secondary text-capitalize"><a href="propertydetail.jsp?pid=<?jsp echo $row['0'];?>"><?jsp echo $row['1'];?></a></h5>
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-primary font-13"></i>&nbsp; <?jsp echo $row['14'];?></span>
                                ...
                                <td></td>
                                <td class="text-capitalize">For</td>
                                <td></td>
								<td class="text-capitalize"></td>
                                <td><a class="btn btn-primary" href="submitpropertyupdate.jsp?id=<?jsp echo $row['0'];?>">Update</a></td>
								<td><a class="btn btn-primary" href="submitpropertydelete.jsp?id=<?jsp echo $row['0'];?>">Delete</a></td>
                            </tr>
