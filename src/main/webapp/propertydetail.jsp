                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="single-property" style="width:1200px; height:700px; margin:30px auto 50px;"> 
                                    <!-- Slide 1-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/property/44.jpg" class="ls-bg" alt="" /> </div>
                                    
                                    <!-- Slide 2-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/property/444.jpg" class="ls-bg" alt="" /> </div>
                                    
                                    <!-- Slide 3-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/property/5.jpg" class="ls-bg" alt="" /> </div>
									
									<!-- Slide 4-->
									<div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/property/55.jpg" class="ls-bg" alt="" /> </div>
									
									<!-- Slide 5-->
									<div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/property/555.jpg" class="ls-bg" alt="" /> </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="bg-primary d-table px-3 py-2 rounded text-white text-capitalize">For <?jsp echo $row['5'];?></div>
                            ...
                            <div class="col-md-6">
                                <div class="text-primary text-left h5 my-2 text-md-right">$<?jsp echo $row['13'];?></div>
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    <li><span class="text-secondary"><?jsp echo $row['12'];?></span> Sqft</li>
                                    <li><span class="text-secondary"><?jsp echo $row['6'];?></span> Bedroom</li>
                                    <li><span class="text-secondary"><?jsp echo $row['7'];?></span> Bathroom</li>
                                    <li><span class="text-secondary"><?jsp echo $row['8'];?></span> Balcony</li>
                                    <li><span class="text-secondary"><?jsp echo $row['10'];?></span> Hall</li>
                                    <li><span class="text-secondary"><?jsp echo $row['9'];?></span> Kitchen</li>
                                </ul>
                            </div>
                            ...
                            <div  class="table-striped font-14 pb-2">
                                <table class="w-100">
                                    <tbody>
                                        <tr>
                                            <td>BHK :</td>
                                            <td class="text-capitalize"><?jsp echo $row['4'];?></td>
                                            <td>Property Type :</td>
                                            <td class="text-capitalize"><?jsp echo $row['3'];?></td>
                                        </tr>
                                        <tr>
                                            <td>Floor :</td>
                                            <td class="text-capitalize"><?jsp echo $row['11'];?></td>
                                            <td>Total Floor :</td>
                                            <td class="text-capitalize"><?jsp echo $row['28'];?></td>
                                        </tr>
                                        <tr>
                                            <td>City :</td>
                                            <td class="text-capitalize"><?jsp echo $row['15'];?></td>
                                            <td>State :</td>
                                            <td class="text-capitalize"><?jsp echo $row['16'];?></td>
                                        </tr>
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseTwo" class="collapse p-4" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                    <img src="admin/property/basement1.jpg" alt="Not Available"> </div>
                                ...
                                <div id="collapseThree" class="collapse p-4" aria-labelledby="headingThree" data-parent="#accordionExample">
                                    <img src="admin/property/ground_floor01.jpg" alt="Not Available"> </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-lg-9">
                                        <div class="agent-data text-ordinary mt-sm-20">
                                            <h6 class="text-primary text-capitalize"><?jsp echo $row['uname'];?></h6>
                                            <ul class="mb-3">
                                                <li><?jsp echo $row['uphone'];?></li>
                                                <li><?jsp echo $row['uemail'];?></li>
                                            </ul>
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
								...
								$query=mysqli_query($con,"SELECT * FROM `property` ORDER BY date DESC LIMIT 6");
										...
										{
								?>
                                <li> <img src="admin/property/<?jsp echo $row['18'];?>" alt="pimage">
