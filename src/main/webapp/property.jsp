                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/5.jpg" alt="pimage">
                                        
                                        <div class="sale bg-secondary text-white">For </div>
                                        <div class="price text-primary text-capitalize">$<?jsp echo $row['13'];?> <span class="text-white"> Sqft</span></div>
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        ...
                                        <div class="px-4 pb-4 d-inline-block w-100">
                                            <div class="float-left text-capitalize"><i class="fas fa-user text-primary mr-1"></i>By : Ganga</div>
                                            <div class="float-right" id="dateContainer">
											    <i class="far fa-calendar-alt text-primary mr-1"></i> 6 Months Ago
											</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
                                ...
                                <li> <img src="admin/property/33.jpg" alt="pimage">
                                    ...
                                    <span class="font-14"><i class="fas fa-map-marker-alt icon-primary icon-small"></i></span>
...
<script>
    ...
    // Format the date
    var formattedDate = sixMonthsAgo.toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' });

    // Update the HTML
    document.getElementById('dateContainer').innerHTML = '<i class="far fa-calendar-alt text-primary mr-1"></i> ' + formattedDate;
</script>
